...
const stepTypeDescriptions: Record<StepType, string> = {
  SerpApi: 'Search Engine Results Page API - Fetch news and search results from various search engines.',
  GPT: 'GPT Language Model - Process and generate text using advanced AI models.'
};
...
export function StepModal({ step, onSave, onCancel }: StepModalProps) {
  const [editedStep, setEditedStep] = useState<PipelineStep>(() => ({
    ...step,
    parameters: {
      ...defaultConfigs[step.type as StepType || 'SerpApi'],
      ...step.parameters
    }
  }));
            ...
            <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    <option value="SerpApi">SerpAPI - Search Engine Results</option>
                    <option value="GPT">GPT - AI Text Processing</option>
                  </select>
